...
const ee = () => {
  ...
  const handleClick = async (event) => {
    ...
    try {
      const data = await fetch("/api/eedpt/hodeelogin", {
        method: "POST",
      ...
      if (response.success === true) {
        ...
        setTimeout(() => {
          setLoading(false);
          router.push("/hodhome/hodeehome");
        }, 1000);
        localStorage.setItem("hodee-token", JSON.stringify(response.token));
      } else {
    ...
    <>
      ...
      <div className="flex items-center justify-center flex-col w-full h-full from-slate-600 bg-gradient-to-t">
        ...
        <div className="bg-green-900 rounded p-2 px-5 absolute top-[5rem] z-10">
          <h1 className="text-white text-3xl uppercase">H.o.d of E.E.</h1>
        </div>
