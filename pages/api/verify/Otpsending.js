...
const OtpSending = (email,name, otpCode) => {
  ...
  let transporter = nodemailer.createTransport({
    ...
    auth: {
      user: "speakup3375@gmail.com",
      pass: "mpcqmjpsmfjeczzl", // Here is app password of above email
    },
  });

  let mailOptions = {
    from: 'Speak-up "speakup3375@gmail.com"', //From where we send the email
  ...
  <div style="font-family: 'Josefin Sans',sans-serif;min-width:1000px;overflow:auto;line-height:2">
    <div style="margin:50px auto;width:70%;padding:20px 0">
      ...
      <p>Thank you for connect with SPEAK-UP. Use the following OTP to complete your Sign Up procedures. <span style = "color:red;"> OTP is valid for only <span style="font-weight:bold;" >3 minutes!!</span> </span> </p>
      <h2 style="background: #14532d;margin: 0 auto;width: max-content;padding: 0 10px;color: #fff;border-radius: 4px;">${otpCode}</h2>
      <p style="font-size:0.9em;">Regards,<br />SPEAK-UP TEAM</p>
  ...
  </div>`, //Here we sending the opt to reciver here it is user`s email
  };
